 ...
 * @Version: v1.0
 */
public class L2022210939_18_Test {
     ...
     */
    @Test
    public void testProductExceptSelf_ValidInput() {
        int[] nums = {1, 2, 3, 4};
     ...
     */
    @Test
    public void testProductExceptSelf_Negative() {
        int[] nums = {-1, -4, 2, -3, 3};
     ...
     */
    @Test
    public void testProductExceptSelf_Zero() {
        int[] nums = {2, 1, 0, -5, 3};
     ...
     */
    @Test
    public void testProductExceptSelf_Null() {
     ...
     */
    @Test
    public void testProductExceptSelf_ZeroElements() {
        int[] nums = {};
        int[] expected = {};
        assertArrayEquals(expected, solution.productExceptSelf(nums));
    }
